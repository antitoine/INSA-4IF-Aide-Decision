...
Pour l'étude, il a été fixé un nombre minimal de produit à fabriquer. Nous avons fait varier ce nombre pour voir s'il n'y a pas un point idéal sur les courbes.\\
...
Nous allons essayer dans cette deuxième partie de satisfaire au mieux les différents responsables. Pour résoudre ce problème, nous allons d'abord établir la matrice avec les points de mire des différents responsable. Ensuite, comme les objectifs des différents responsables sont exprimés dans des unités différentes, il faut normaliser la matrice des points de mire.

\section{Obtention des points de mire}
On calcule dans un premier le résultat espéré pour chaque responsable, en fonction du point de mire des autres responsables. On obtient alors le tableau suivant : 
...
Resp. Atelier &  & \cellcolor{blue!10}378,63 &  &  &  \\ 
Resp Stock &  &  & \cellcolor{blue!10}$1\:003\,$ unités de stocks &  & \\ 
Resp Commercial &  &  &  & \cellcolor{blue!10}$\frac{q_A}{q_E}=1$ &  \\ 
Resp Personnel &  &  &  &  & \cellcolor{blue!10}$940\,$ min \\ 
\end{tabular}
...
% 
10408.9028          356.67         1689.68            -235         3965.69
  9593.157          378.63         1833.57         -176.71         3801.89
6479.20275             234          1002.5           -51.5            1967
7466.03334          374.89         1829.79               0         2678.88
 2499.5935             345            1795             270             940
8219.57732        372.7819       1799.9998             -60       3061.5786


Cette matrice ne permet pas de faire ressortir de résultats qui paraissent satisfaisant au premier abord. On peut juste constater qu'il va falloir trouver un compromis que se rapproche au plus du point de mire de chaque responsable.

\section{Normalisation de la matrice}

Nous pouvons ensuite normaliser la matrice obtenu pour ne pas tenir compte des unités. On mesure ainsi le rapport entre le point de mire de chaque responsable et le résultat qu'il obtient avec la solution d'un autre responsable. On obtient alors le résultat suivant : 
...
Comme aucun résultat ne semble être meilleur que les autres, on va dégrader successivement les différentes fonctions objectif des responsables de manière à trouver une solution optimale.\\
