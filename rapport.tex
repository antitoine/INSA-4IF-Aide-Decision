...
\begin{tabular}{c|ccccc}
 & Comptable (€) & Resp. Atelier (Unités) & Resp Stock (Stock total) & Resp Commercial ($\abs{q_A - q_E}$) &  Resp Personnel (min) \\ 
\hline 
...
Resp Personnel & 2 499,60 & 345 & 1795 & 270 & \cellcolor{blue!10}$940\,$ min \\ 
\end{tabular}
...
\quot{``Soit une solution A. On la compare avec une autre solution B. Si la discordance de A par rapport à B est inférieure au seuil de discordance et que la concordance de A par rapport à B est supérieure au seuil de concordance, alors la solution A domine la B.''}\\
